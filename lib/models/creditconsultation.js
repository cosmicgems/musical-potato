...
const creditConsultationSchema = new Schema({
  name: {
    type: String,
    trim: true,
    required: true,
  ...
  ssn: {
    ...
    validate: {
      validator: (value) => {
        return validator.isNumeric(value) && validator.isLength(value, { min: 9, max: 9 });
      },
      message: 'Invalid SSN.',
    },
  },
...
const CreditConsultation = models.CreditConsultation || model('CreditConsultation', creditConsultationSchema);
